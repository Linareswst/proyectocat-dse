        ...
        public bool Registrar(Habitacion oHabitacion)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    //cmd.Parameters.AddWithValue("Precio", oHabitacion.Precio);
        ...
        public List<Habitacion> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    query.AppendLine("select h.IdHabitacion,h.Numero,h.Detalle,p.IdPiso,p.Descripcion[DescripcionPiso],c.IdCategoria,c.Descripcion[DescripcionCategoria],h.Estado,");
